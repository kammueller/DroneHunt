...
*/
        ...
        try {
            ...
            if (files.length != 1) {
                ...
                if ((files[0] == null)) {
                    Log.e("FTP", "no picture at all there");
                    return; // only quit when no pic
                }
            }
            ...
            InputRepresentation ir = new InputRepresentation(stream, MediaType.IMAGE_JPEG);
            // TODO: 13.11.2016 fix server-adress!!
            new ClientResource("http://192.168.2.4:9000/uploadNewHint").post(ir);
            Log.e("FTP", "uploaded");
